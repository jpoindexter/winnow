...
export function detectContentType(text) {
    ...
    if (nonTextRatio(text) > BINARY_RATIO)
        return "binary";
 ...
 */
export function compressText(raw, options = {}) {
