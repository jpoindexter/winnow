...
export declare const compress: typeof applyCompression;
...
export declare function stats(before: string, after: string): Savings;
...
export declare function compressMessages<T extends {
    content: string;
}>(messages: T[], opts?: ApplyOptions): Promise<T[]>;
